    ...
    <>
      ...
      <section className='py-16 sm:py-24 px-6 sm:px-10 text-center'>
        <div className='max-w-2xl mx-auto'>
          <p className='text-xs font-medium tracking-widest uppercase text-[#8a5a1a] mb-3'>Empezá hoy</p>
          <h2 className='text-3xl sm:text-4xl lg:text-5xl font-black text-[#3d2b1f] mb-4' style={{ fontFamily: 'Georgia, serif' }}>
            {config.ctaTitulo}
          </h2>
          <p className='text-[#5c4033] text-base sm:text-lg font-light mb-8'>{config.ctaSubtexto}</p>
          <a
            href='#productos'
